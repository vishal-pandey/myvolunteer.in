		...
		<div class="col-12 content">
			<div class="maincontent well col-9">
					  ...
					  <div id="myCarousel" class="carousel slide" data-ride="carousel">
					    ...
					    <div class="carousel-inner" role="listbox">
					      ...
					      <div class="item active">
					        <img src="./pics/1.jpg" alt="www.myvolunteer.in"  height="345">
					      ...
					      <div class="item">
					        <img src="./pics/4.jpg" alt="www.myvolunteer.in"  height="345">
					        <div class="carousel-caption">
					          <h3></h3>
					          <p></p>
					        </div>
					      ...
					      <div class="item">
					        <img src="./pics/5.jpg" alt="www.myvolunteer.in"  height="345">
					        <div class="carousel-caption">
					          <h3></h3>
					          <p></p>
					        </div>
					      ...
					      <div class="item">
					        <img src="./pics/6.jpg" alt="www.myvolunteer.in"  height="345">
					        <div class="carousel-caption">
					          <h3></h3>
					          <p></p>
					        </div>
				...
				<div class="col-sm-12 well">
					<div class="col-sm-4"><img src="./pics/partner3.png" style="width: 100%; margin-top: ;" alt="Abhiyanjana Go Green"></div>
					<div class="col-sm-4"><center><img src="./pics/partner1.png" style="width: 60%;" alt="ECO Kart Series"></center></div>
					<div class="col-sm-4"><img src="./pics/partner2.png" style="width: 100%; margin-top: 15%;" alt="Off Road Battle"></div>					
				</div>
				<hr>				
			</div>
